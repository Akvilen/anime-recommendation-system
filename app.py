...
def main():
    ...
    selected_user_id = my_expander.selectbox('', unique_user_id, label_visibility="collapsed")
    selected_user_id = my_expander.selectbox(
    'Select User ID:', ['Select a User'] + unique_user_id
)
